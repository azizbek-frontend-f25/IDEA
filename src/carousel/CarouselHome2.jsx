...
const CarouselHome2 = () => {
  return (
    <div className="bg-white rounded-xl 2xl:h-[410px] h-[380px]">
      <h1 className="text-2xl px-1 text-start mx-5 py-4">
        Odamlar ko'pincha qidirishadi
      </h1>

      <div className="overflow-y-scroll w-[310px] h-[280px] 2xl:h-[340px] py-4 2xl:w-[350px]">
        <p className="px-1 text-start mx-5 text-[16px] py-3 border-b-2">
          Купить телевизор LG
        </p>
        ...
        <p className="px-1 text-start mx-5 text-[16px] py-3">
