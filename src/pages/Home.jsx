  ...
  return (
    <div className='container'>
      <div className={`flex items-center gap-5 justify-between`}>
        <CarouselHome />
        <img onClick={() => navigate("/bolib-tolash")} className='hidden xl:block w-[25%] 2xl:w-[350px] h-[380px] 2xl:h-[410px] rounded-xl' src="https://idea.uz/_next/image?url=https%3A%2F%2Fapi.idea.uz%2Fstorage%2Fpromotions%2FAugust2023%2F1zxcgEfO8opa86eR9Wfs.png&w=1920&q=75" alt="img" />
